...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST api/category</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT api/category/{category}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE api/category/{category}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET category/{slug}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET admin/posts/{post}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT admin/posts/submit/{post}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE admin/post/{post}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT admin/comment/{comment}</code></p>
<!-- END_060f7edf29e4a953798c2ead7df124ad -->
<!-- START_3f5128f7717baab57d2069edd36059d9 -->
<h2>Mark specified Comment as spam</h2>
<blockquote>
<p>Example request:</p>
</blockquote>
<pre><code class="language-bash">curl -X PUT \
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT admin/comment/spam/{comment}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE admin/comment/{comment}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET admin/category</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>POST admin/category</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET admin/category/{category}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT admin/category/{category}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE admin/category/{category}</code></p>
...
<h3>HTTP Request</h3>
<p><code>GET admin/tags/{tag}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>PUT admin/tags/{tag}</code></p>
...
fetch(url, {
    ...
    .then(json =&gt; console.log(json));</code></pre>
<h3>HTTP Request</h3>
<p><code>DELETE admin/tags/{tag}</code></p>
